...
This Code of Conduct is adapted from [Atom's Code of Conduct](https://github.com/atom/atom/blob/master/CODE_OF_CONDUCT.md) under the MIT License, which in turn was adapted from the [Contributor Covenant][homepage], version 1.4, available at [https://contributor-covenant.org/version/1/4][version]

[contact]: https://peterhcharlton.github.io/#contact
